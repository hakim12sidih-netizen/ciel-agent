...
- **`PROJECT_RESOURCES`** (`list`) — `[ACPResource(uri='project://structure', name='Structure du projet', description='Arborescence des fichiers du projet', m`
- **`RESOURCE_HANDLERS`** (`dict`) — `{'project://structure': <function handle_project_structure at 0x7f41efbdcd50>, 'ciel://status': <function handle_ciel_st`
...
### `handle_ciel_status(kwargs)`

### `handle_project_structure(kwargs)`
