...
Theme(name: 'str', description: 'str' = '', colors: 'dict[str, str]' = <factory>, is_dark: 'bool' = True)

**Méthodes :**

- **`__init__(name: str, description: str = '', colors: dict[str, str] = <factory>, is_dark: bool = True)`**
...
### `get_theme_css(theme_name: str | None = None)`

### `get_theme_tcss(theme_name: str | None = None)`
