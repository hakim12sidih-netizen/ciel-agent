...
class ProviderRouter:
    """Route les requêtes LLM vers le provider approprié selon le modèle demandé."""
    ...
    def resolve(self, model: str) -> str:
        for prefix, provider in self._routing.items():
            if model.lower().startswith(prefix):
                return provider
        return "openai"

    def register_route(self, prefix: str, provider: str) -> None:
        self._routing[prefix.lower()] = provider
