...
import { Message, LLMProvider } from '../../providers/Provider.js';
...
export class TrajectoryCompressor {
   ...
   */
  public async compressIfNeeded(history: Message[]): Promise<Message[]> {
  ...
  private buildSummaryPrompt(messagesToCompress: Message[]): string {
