...
AGENT_DESCRIPTIONS: dict[AgentRole, str] = {
    ...
    AgentRole.HERMES: "communication, messager, inter-plateforme",
...
class Pantheon:
    ...
    def _expertise_for(role: AgentRole) -> list[str]:
        expertise_map: dict[AgentRole, list[str]] = {
            ...
            AgentRole.HERMES: ["communication", "réseau", "traduction", "messagerie"],
...
# ── HydraEngine — entry point principal ────────────────────────────────────

class HydraEngine:
    """Moteur HYDRA complet — Darwinian Evolution, Pantheon, RL, Self-Rewriting.

    Intègre:
    - Pantheon: 11 agents Olympiens + consensus BCQ
    - HydraBrain: cycle OODA
