...
export class HydraToolRegistry {
    activeDomain = 'core';
    evolution = new EvolutionRegistry();
    cognitive = new CognitiveRegistry();
    network = new NetworkRegistry();
    labs = new LabsRegistry();
    ...
    getAvailableTools() {
        ...
        switch (this.activeDomain) {
            case 'evolution':
                domainTools = this.evolution.getTools();
                break;
            case 'cognitive':
                domainTools = this.cognitive.getTools();
                break;
            case 'network':
                domainTools = this.network.getTools();
                break;
            case 'labs':
                domainTools = this.labs.getTools();
                break;
            case 'execution':
                domainTools = this.execution.getTools();
                break;
            case 'core':
            default:
                break;
